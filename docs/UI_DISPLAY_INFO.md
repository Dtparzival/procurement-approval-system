...
### 橫向模式參考文件區塊和錯誤狀態優化（v1.9.5 新增）

針對 iPhone 14 Pro Max 等大螢幕手機橫向模式進行的優化：

| 元素 | 優化內容 |
| :--- | :--- |
| 參考文件區塊 | 縮小上傳區域、優化已上傳文件列表顯示 |
| 錯誤狀態 | 縮小圖示/標題/訊息、按鈕橫向排列、幫助連結橫向排列 |
| 結果容器 | 設定最大高度和滾動以顯示完整內容 |
...
- **2025-12-28**：新增橫向模式參考文件區塊和錯誤狀態優化說明（v1.9.5）。
