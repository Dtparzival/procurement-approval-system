...
docs/
├── README.md                    # 本文件（索引）
├── Agent_智簽公文_PRD_v1.2.md  # 產品需求文件 (PRD)
...
完整的產品需求文件，包含業務流程、功能規格、畫面狀態轉換等詳細說明。

| 文件 | 描述 | 優先級 |
|:---|:---|:---:|
| **[Agent_智簽公文_PRD_v1.2.md](Agent_智簽公文_PRD_v1.2.md)** | 完整的產品需求文件，包含從登入到登出的所有業務流程 | ⭐⭐⭐⭐⭐ |

**推薦閱讀**: 這份文件詳細說明了系統的所有功能需求、業務流程和畫面狀態轉換，是理解系統整體運作的最佳入口。
...
| 日期 | 更新內容 | 版本 |
|:---|:---|:---:|
| 2025-12-25 | 新增產品需求文件 (PRD) v1.2 | 1.6 |
